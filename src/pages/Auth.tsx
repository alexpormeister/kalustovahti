...
const signupSchema = loginSchema.extend({
  fullName: z.string().min(2, "Nimi on pakollinen"),
});
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      if (error.message.includes("User already registered")) {
        toast.error("Tämä sähköpostiosoite on jo rekisteröity");
      } else {
        toast.error("Rekisteröinti epäonnistui: " + error.message);
      }
    } else {
      toast.success("Rekisteröinti onnistui! Tarkista sähköpostisi vahvistuslinkin saamiseksi.");
    }
    setLoading(false);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">Fleet Manager</h1>
          <p className="text-muted-foreground">Taksikaluston hallintajärjestelmä</p>
        </div>
